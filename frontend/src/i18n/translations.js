export const translations = {
  ru: {
    ...
    'manage_accounts': 'Управление учётными записями',
    'refresh': 'Обновить',
    'create_user': 'Создать пользователя',
    'new_user': 'Новый пользователь',
    'create_new_account': 'Создайте новую учётную запись пользователя',
    ...
    'reset_password_desc': 'Введите новый пароль для пользователя',
    'change_role_title': 'Изменить роль',
    'change_role_desc': 'Изменить права пользователя',
    ...
    'password_reset': 'Пароль изменён успешно',
    ...
    'add_ip_to_blacklist': 'Добавить IP в чёрный список',
    'enter_ip': 'Введите IP адрес',
    'enter_ips': 'Введите IP адреса (по одному на строку)',
    'expires_hours': 'Истекает через (часов)',
    'permanent': 'Постоянно',
    'device_name': 'Устройство',
    'last_active': 'Последняя активность',
    'gps_location': 'GPS локация',
    'view_map': 'Показать на карте',
    'no_location': 'Нет данных',
    'attempt_time': 'Время',
    'success': 'Успешно',
    'failed': 'Неудачно',
    'system': 'Система',
    'devices_count': 'Устройств',
    'view_devices': 'Посмотреть устройства',
    ...
    'change_connection': 'Изменить подключение',
    'ssl_status': 'Статус SSL',
    'ssl_expires': 'Истекает',
    'renew_ssl': 'Перевыпустить SSL',
    'renew_domain_ssl': 'Перевыпустить для домена',
    'renew_ip_ssl': 'Перевыпустить для IP',
    'auto_renew_ssl': 'Автоматически обновлять SSL',
    ...
    'backup_restored': 'Восстановлено из бэкапа',
    'include_settings': 'Включить настройки',
    'include_users': 'Включить пользователей',
    'include_chats': 'Включить метаданные чатов',
    ...
    'no_messages_content': 'Содержимое сообщений зашифровано (E2EE)',
  ...
  en: {
    ...
    'reset_password_desc': 'Enter new password for user',
    'change_role_title': 'Change Role',
    'change_role_desc': 'Change user permissions',
    ...
    'unblock': 'Unblock',
    'block_ip': 'Block IP',
    'add_ip_to_blacklist': 'Add IP to Blacklist',
    'enter_ip': 'Enter IP address',
    'enter_ips': 'Enter IP addresses (one per line)',
    'expires_hours': 'Expires in (hours)',
    'permanent': 'Permanent',
    'device_name': 'Device',
