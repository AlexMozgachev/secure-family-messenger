...
print_final_info() {
    ...
    echo -e "${GREEN}================================================================${NC}"
    echo ""
    echo -e "${BLUE}📱 Веб-интерфейс:${NC}     http://127.0.0.1:3000"
    echo -e "${BLUE}🔧 API документация:${NC}  http://127.0.0.1:8001/docs"
    echo -e "${BLUE}👤 Админ-панель:${NC}      http://127.0.0.1:3000/admin"
    echo ""
